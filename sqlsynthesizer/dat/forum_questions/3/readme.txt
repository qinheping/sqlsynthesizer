...
I have a table by name provider and it has columns loginid,provider and city.I want to write a query to get the loginid for which the provide count is more than 5.													
