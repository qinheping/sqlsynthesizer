...
Inferring SQL queries from examples can be challenging.
This is primarily because \todo{some reasons.}.
\ourtool focuses on an \todo{important} SQL subset (described in Section~\ref{sec:langsubset}),
...
\CodeIn{MAX()}, \CodeIn{MIN()}, \CodeIn{SUM()},
