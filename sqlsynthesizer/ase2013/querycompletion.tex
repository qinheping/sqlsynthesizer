...
\CodeIn{MIN}, \CodeIn{SUM}, and \CodeIn{AVG} for a numeric type column;
...
are used \textit{together with} the \CodeIn{GROUP BY} clause
and \textit{inside} the \CodeIn{HAVING} clause.
...
places condition: \CodeIn{COUNT(enrolled.course\_id) > 2}
in the \CodeIn{HAVING} clause, and places 
