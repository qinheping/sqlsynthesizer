...
to the example output. However, according to our ranking strategy, Query 1
contains less conditions, and thus is simpler than Query 2 and ranks higher.
By contrast, a query containing more conditions like Query 2 is more likely
to overfit only the given examples.}}
\end{figure}
