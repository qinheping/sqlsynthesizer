...
output, but do not address the intention that the user wants;
\ourtool can be used interactively by getting more
informative examples from the end-user and then refining the result queries.

Take the query in Figure~\ref{fig:queryex} as an example,
for each SQL query, the ``Skeleton Creation''
