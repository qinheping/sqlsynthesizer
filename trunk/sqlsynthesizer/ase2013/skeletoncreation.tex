...
For example, suppose the column \CodeIn{student\_id}
...
a column with the same name appears in an input table.
...
projection columns, but differ in the join conditions.
