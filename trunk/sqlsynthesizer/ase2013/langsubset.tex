...
insteading of supporting all features in the standard
...
features voted by the survey participants, except for the \CodeIn{IN} keyword
in Figure~\ref{fig:survey}.
...
\begin{figure}[t]
  ...
  \vspace*{-1.0ex}\caption {{\label{fig:queryex}
...
vendor-specific features, e.g., the \CodeIn{TOP}
...
The \CodeIn{LIKE} is also discarded, since it is used for
...
it 3, because this participant mis-interpreted the designed
